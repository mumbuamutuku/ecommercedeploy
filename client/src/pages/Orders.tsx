      ...
      {loading ? ( 
        <Loading /> 
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-sm max-w-[600px] tracking-wide text-gray-500 text-justify"> 
                Welcome to Your Orders Page! Here, you can view the details and status of all your recent orders. Easily track shipments, review past purchases, and manage any returns or exchanges. For each order, you'll find information on the items purchased, order date, shipping status, and delivery estimates. If you need any assistance or have any questions, our support team is just a click away. Thank you for shopping with us!
            </p>
                        ...
                        <DisclosurePanel as="dd" className="mt-5 pr-12">
                          <div className="flex flex-col gap-2 bg-#[f4f4f480] p-5 border border-gray-200">
                            ...
                            {order?.orderItems?.map((item:ProductProps) =>(
                              <div key={item?._id} className="flex space-x-6 border-b
                              border-gray-200 py-3">
                                <Link to={`/product/${item?._id}`} className="h-20 w-20 flex-none sm:h-40 sm:w-40 rounded-lg bg-gray-100 border border-gray-300 hover:border-skyText overflow-hidden">
