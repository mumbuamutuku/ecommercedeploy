      ...
      {favoriteProduct?.length > 0 ? (
        <div>
          <div className="border-b border-b-gray-300 pb-6">
            ...
            Welcome to your Favorites page! Here, you can easily find and manage all the items you've loved from our shop. Whether you're planning your next purchase or just keeping track of your top picks, this personalized collection ensures your favorite products are always just a click away. Enjoy browsing through your curated list and happy shopping!
            </p>
          </div>
