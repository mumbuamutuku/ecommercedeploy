              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10"> 
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {color && (
                    <button 
                      onClick={() => setColor("")}
                      className="font-semibold mt-1 flex items-center
                      gap-1 hover:text-red-600 duration-200">
                      <IoClose /> Clear
                    </button>
                  )}
                  </div>
                ...
                flex-col items-center justify-center gap-2">
                  <img src={productPayment} alt="payment" 
                    className="w-auto object-cover"
                  />
                  <p className="font-semibold"> 
                    Guaranteed Safe & Secure Checkout </p>
                </div>
                </div>
              </div> ) : (
                /**View All Products */
