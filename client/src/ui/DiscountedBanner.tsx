        ...
        <Container>
            ...
            <div className="my-7 flex items-center flex-wrap gap-4">
                {popularSearchItems?.map(({title,link}) => (
                    ...
                    key={title} 
                    to={`/category/${link}`}
                    className="border border-[px] border-gray-300 px-8 py-3
                    rounded-full capitalize font-medium hover:bg-black duration-200
                    hover:text-white"
                    >
                        {title}
                    </Link>
            ...
            rounded-lg flex items-center justify-between overflow-hidden">
                ...
                <div className="flex flex-col flex-1 gap-1 items-center">
                    ...
                    text-xl md:text-4xl font-bold">
                        ...
                        <Link
                          to={'/product'}
                          className="border border-red-600 px-4 py-2 text-xl
                          md:text-3xl text-red-600 rounded-full"
                        >
                          Discount 20%
                        </Link>
                    </div>
            ...
            <div className="mt-7">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 mt-7">
                    <div className="border border-r-0 border-gray-300 flex 
