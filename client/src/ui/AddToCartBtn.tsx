...
import PriceTag from "../pages/PriceTag";
  ...
  return (
    ...
    {showPrice && (
      ...
      {existingProduct ? ( 
        ...
        >
          <button onClick={handleDeleteProduct} className="bg-[#7#7#7] text-black p-2 border-[1px]
          ...
          <p className="text-base font-semibold w-10 text-center">
            {existingProduct?.quantity}</p>

          <button onClick={handleAddToCart} className="bg-[#7#7#7] text-black p-2 border-[1px]
          border-gray-200 hover:border-skyText rounded-full text-sm
          hover:bg-white duration-200 cursor-pointer">
            <FaPlus />
          </button>
